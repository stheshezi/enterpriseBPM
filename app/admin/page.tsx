...
export default async function AdminPage() {
  await requireAnyPermission(PERMISSIONS.USERS_VIEW);
  ...
  return (
    <PageContainer>
      ...
      <section className="dashboard-grid">
        {/* Support Hub navigation removed per user request */}
        ...
        <Link className="feature-card" href="/admin/request-types"><h2>Request Types</h2><p>Configure categories for dynamic forms and workflow routing.</p></Link>
